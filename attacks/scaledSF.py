...
###
 ...
 # but with a twist: the attack gradients are scaled by a factor to nullify the total average gradient
###
...
def attack(grad_honests, f_real, **kwargs):
  ...
  byz_grad = avg_grad.mul(-1).mul(len(grad_honests) / f_real)
...
# Register the attack
register("scaledSF", attack, check)
